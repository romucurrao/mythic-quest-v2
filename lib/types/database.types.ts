  ...
  public: {
    Tables: {
      ...
      heroes: {
        ...
        Update: { id?: string; user_id?: string; name?: string; avatar?: string; patron_god?: string; class?: string; level?: number; xp?: number; gold?: number; streak?: number; last_active_date?: string | null; strength?: number; wisdom?: number; discipline?: number; charisma?: number; creativity?: number; total_quests_completed?: number; created_at?: string }
      }
      quests: {
        Row: {
          id: string
        ...
        Update: { id?: string; user_id?: string; name?: string; description?: string | null; category?: string; difficulty?: string; frequency?: string; is_completed?: boolean; last_reset_date?: string | null; xp_reward?: number; gold_reward?: number; attribute_bonus?: string | null; created_at?: string }
      }
      achievements: {
        Row: {
          id: string
